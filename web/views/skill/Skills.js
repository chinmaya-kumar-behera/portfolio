...
//                 <p>{el.desc.length > 200 ? el.desc.slice(0,100) : el.desc}</p>
//               </div>
//               {el.desc.length > 200 && (
//                 <div className="">
//                   <button
//                     onClick={() => onReadMoreClick(el.ind)}
...
//         </div>
//         {modal && (
//           <SkillDetails isOpen={modal} onClose={() => setModal(false)} />
//         )}
//       </PageContainer>
//     </main>
//   );
